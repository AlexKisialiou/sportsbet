# Russian translations for team names
# Key: English name from football-data.org API
# Value: Russian name
TEAMS_RU = {
    # Испания
    ...
    # Португалия
    "Sport Lisboa e Benfica"            : "Бенфика",
    "FC Porto"                          : "Порту",
